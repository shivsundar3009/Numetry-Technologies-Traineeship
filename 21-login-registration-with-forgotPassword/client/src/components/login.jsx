...
import welcome from '../assets/music.jpg'
...
function Login() {
  ...
  return (
    <div className=' h-screen flex justify-center' style={{backgroundImage: `url(${welcome}`}}>
      ...
      <div className='bg-white h-80 p-10 text-center mt-10 rounded-xl flex flex-col gap-2'>
         ...
         <img src={`${welcome}`} alt="" className='h-8' />
           <h2 className='font-serif text-xl'>Admin Sign In</h2>
         </div>
